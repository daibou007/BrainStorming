...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:0.0f] ];
    [[UINavigationBar appearance] setTintColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:0.0f]];
